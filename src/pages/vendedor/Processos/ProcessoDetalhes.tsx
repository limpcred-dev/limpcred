        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-900">{processo.clienteNome}</p>
            </div>
            <div>
              ...
              <span className={`mt-1 inline-flex px-2 text-xs leading-5 font-semibold rounded-full ${
                ...
                'bg-yellow-100 text-yellow-800' // Pendentes de envio
              }`}>
                {processo.status}
              </span>
            </div>
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-500 mb-2">Método de Pagamento</h3>
            <p className="text-sm text-gray-900 capitalize">{processo.metodoPagamento}</p>
          </div>

          {processo.observacoes && (
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-2">Observações</h3>
              <p className="text-sm text-gray-900">{processo.observacoes}</p>
            </div>
          )}
